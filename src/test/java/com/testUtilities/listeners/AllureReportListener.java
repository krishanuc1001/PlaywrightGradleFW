...
public class AllureReportListener implements ITestListener {
  ...
  // testResult.setName(data.get("TestDescription")));
  //            lifecycle.updateTestCase(testResult ->
  // testResult.setDescription(data.get("TestDescription")));
  //        }
  //    }
  ...
  //        WebDriver driver = DriverManager.getDr();
  //        System.out.println("Screenshot has captured for the Test Method '" +
  // getTestMethodName(iTestResult) + "'");
  //        Allure.addAttachment(getTestMethodName(iTestResult), new
  ...
  //            System.out.println("Screenshot has captured for the Test Method '" +
  // getTestMethodName(iTestResult) + "'");
  //            Allure.addAttachment(iTestResult.getThrowable().getMessage(), new
  // ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
